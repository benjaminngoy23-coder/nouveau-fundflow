...
class FundFlowHandler(BaseHTTPRequestHandler):
    ...
    def login(self, method: str) -> None:
        ...
        <div class="auth-card">
            ...
            <form method="post">
                <label>Email</label><input name="email" type="email" required autocomplete="username" placeholder="Votre adresse e-mail">
                <label>Mot de passe</label><input name="password" type="password" required autocomplete="current-password" placeholder="Votre mot de passe">
